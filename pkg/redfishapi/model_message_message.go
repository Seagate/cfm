...
// AssertMessageMessageRequired checks if the required fields are not zero-ed
func AssertMessageMessageRequired(obj MessageMessage) error {
...
// AssertMessageMessageConstraints checks if the values respects the defined constraints
func AssertMessageMessageConstraints(obj MessageMessage) error {
	return nil
}
