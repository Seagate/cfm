...
// AssertChassisCollectionChassisCollectionRequired checks if the required fields are not zero-ed
func AssertChassisCollectionChassisCollectionRequired(obj ChassisCollectionChassisCollection) error {
...
// AssertChassisCollectionChassisCollectionConstraints checks if the values respects the defined constraints
func AssertChassisCollectionChassisCollectionConstraints(obj ChassisCollectionChassisCollection) error {
	return nil
}
