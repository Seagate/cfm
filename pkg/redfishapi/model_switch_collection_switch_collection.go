...
// AssertSwitchCollectionSwitchCollectionRequired checks if the required fields are not zero-ed
func AssertSwitchCollectionSwitchCollectionRequired(obj SwitchCollectionSwitchCollection) error {
...
// AssertSwitchCollectionSwitchCollectionConstraints checks if the values respects the defined constraints
func AssertSwitchCollectionSwitchCollectionConstraints(obj SwitchCollectionSwitchCollection) error {
	return nil
}
