...
// AssertEndpointCollectionEndpointCollectionRequired checks if the required fields are not zero-ed
func AssertEndpointCollectionEndpointCollectionRequired(obj EndpointCollectionEndpointCollection) error {
...
// AssertEndpointCollectionEndpointCollectionConstraints checks if the values respects the defined constraints
func AssertEndpointCollectionEndpointCollectionConstraints(obj EndpointCollectionEndpointCollection) error {
	return nil
}
