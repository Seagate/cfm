...
// ResourceV1190PostalAddress - The postal address for a resource.
type ResourceV1190PostalAddress struct {
...
// AssertResourceV1190PostalAddressRequired checks if the required fields are not zero-ed
func AssertResourceV1190PostalAddressRequired(obj ResourceV1190PostalAddress) error {
	return nil
}

// AssertResourceV1190PostalAddressConstraints checks if the values respects the defined constraints
func AssertResourceV1190PostalAddressConstraints(obj ResourceV1190PostalAddress) error {
	return nil
}
