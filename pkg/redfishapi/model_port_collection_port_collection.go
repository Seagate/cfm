...
// AssertPortCollectionPortCollectionRequired checks if the required fields are not zero-ed
func AssertPortCollectionPortCollectionRequired(obj PortCollectionPortCollection) error {
...
// AssertPortCollectionPortCollectionConstraints checks if the values respects the defined constraints
func AssertPortCollectionPortCollectionConstraints(obj PortCollectionPortCollection) error {
	return nil
}
