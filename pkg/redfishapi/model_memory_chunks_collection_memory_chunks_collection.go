...
// AssertMemoryChunksCollectionMemoryChunksCollectionRequired checks if the required fields are not zero-ed
func AssertMemoryChunksCollectionMemoryChunksCollectionRequired(obj MemoryChunksCollectionMemoryChunksCollection) error {
...
// AssertMemoryChunksCollectionMemoryChunksCollectionConstraints checks if the values respects the defined constraints
func AssertMemoryChunksCollectionMemoryChunksCollectionConstraints(obj MemoryChunksCollectionMemoryChunksCollection) error {
	return nil
}
