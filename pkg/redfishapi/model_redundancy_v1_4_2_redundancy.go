...
// AssertRedundancyV142RedundancyRequired checks if the required fields are not zero-ed
func AssertRedundancyV142RedundancyRequired(obj RedundancyV142Redundancy) error {
...
// AssertRedundancyV142RedundancyConstraints checks if the values respects the defined constraints
func AssertRedundancyV142RedundancyConstraints(obj RedundancyV142Redundancy) error {
	return nil
}
