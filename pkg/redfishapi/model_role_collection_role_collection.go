...
// AssertRoleCollectionRoleCollectionRequired checks if the required fields are not zero-ed
func AssertRoleCollectionRoleCollectionRequired(obj RoleCollectionRoleCollection) error {
...
// AssertRoleCollectionRoleCollectionConstraints checks if the values respects the defined constraints
func AssertRoleCollectionRoleCollectionConstraints(obj RoleCollectionRoleCollection) error {
	return nil
}
