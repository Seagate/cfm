...
// AssertMemoryCollectionMemoryCollectionRequired checks if the required fields are not zero-ed
func AssertMemoryCollectionMemoryCollectionRequired(obj MemoryCollectionMemoryCollection) error {
...
// AssertMemoryCollectionMemoryCollectionConstraints checks if the values respects the defined constraints
func AssertMemoryCollectionMemoryCollectionConstraints(obj MemoryCollectionMemoryCollection) error {
	return nil
}
