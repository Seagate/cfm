...
// AssertResourceV1180PostalAddressRequired checks if the required fields are not zero-ed
func AssertResourceV1180PostalAddressRequired(obj ResourceV1180PostalAddress) error {
	return nil
}

// AssertResourceV1180PostalAddressConstraints checks if the values respects the defined constraints
func AssertResourceV1180PostalAddressConstraints(obj ResourceV1180PostalAddress) error {
	return nil
}
