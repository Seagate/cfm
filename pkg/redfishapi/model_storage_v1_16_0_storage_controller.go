...
// StorageV1160StorageController - The StorageController schema describes a storage controller and its properties.  A storage controller represents a physical or virtual storage device that produces volumes.
type StorageV1160StorageController struct {
...
// AssertStorageV1160StorageControllerRequired checks if the required fields are not zero-ed
func AssertStorageV1160StorageControllerRequired(obj StorageV1160StorageController) error {
...
// AssertStorageV1160StorageControllerConstraints checks if the values respects the defined constraints
func AssertStorageV1160StorageControllerConstraints(obj StorageV1160StorageController) error {
