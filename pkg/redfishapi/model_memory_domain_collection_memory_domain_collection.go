...
// AssertMemoryDomainCollectionMemoryDomainCollectionRequired checks if the required fields are not zero-ed
func AssertMemoryDomainCollectionMemoryDomainCollectionRequired(obj MemoryDomainCollectionMemoryDomainCollection) error {
...
// AssertMemoryDomainCollectionMemoryDomainCollectionConstraints checks if the values respects the defined constraints
func AssertMemoryDomainCollectionMemoryDomainCollectionConstraints(obj MemoryDomainCollectionMemoryDomainCollection) error {
	return nil
}
