...
// AssertApplianceRequired checks if the required fields are not zero-ed
func AssertApplianceRequired(obj Appliance) error {
	...
	if err := AssertMemberItemRequired(obj.Blades); err != nil {
		return err
	}
	return nil
}

// AssertApplianceConstraints checks if the values respects the defined constraints
func AssertApplianceConstraints(obj Appliance) error {
	if obj.Port < 80 {
